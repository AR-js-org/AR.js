...
MarkersAreaControls.fromJSON = function(arToolkitContext, parent3D, markerRoot, jsonData, parameters){
	...
	multiMarkerFile.subMarkersControls.forEach(function(item){
		...
		var subMarkerControls = new ArMarkerControls(arToolkitContext, markerRoot, item.parameters)
...
// }
	...
	var multiMarkerControls = new ArMultiMarkerControls(arToolkitContext, markerRoot, parameters)
