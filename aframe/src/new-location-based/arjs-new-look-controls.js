 ...
 *
 * 120322 arjs-new-look-controls based on arjs-look-controls, but using the 
 * modified THREE DeviceOrientationControls from the three.js location-based 
 * AR.js implementation, to avoid duplication.
 */

import * as AFRAME from 'aframe'
//import ArjsDeviceOrientationControls from '../location-based/ArjsDeviceOrientationControls'

AFRAME.registerComponent('arjs-new-look-controls', {
  ...
  setupMagicWindowControls: function () {
    ...
    if (AFRAME.utils.device.isMobile()) {
      magicWindowControls = this.magicWindowControls = new THREEx.DeviceOrientationControls(this.magicWindowObject);
