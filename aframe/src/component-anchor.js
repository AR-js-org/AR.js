    ...
    init: function () {
        ...
        var timerId = setInterval(function () {
            ...
            if (_this.data.preset === 'hiro') {
                ...
                markerParameters.patternUrl = THREEx.ArToolkitContext.baseURL + 'three.js/examples/marker-training/examples/pattern-files/pattern-hiro.patt'
                markerParameters.markersAreaEnabled = false
            } else if (_this.data.preset === 'kanji') {
                markerParameters.type = 'pattern'
                markerParameters.patternUrl = THREEx.ArToolkitContext.baseURL + 'three.js/examples/marker-training/examples/pattern-files/pattern-kanji.patt'
                markerParameters.markersAreaEnabled = false
