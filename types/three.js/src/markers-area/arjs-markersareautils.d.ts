...
declare namespace MarkersAreaUtils {
     ...
     */
    function navigateToLearnerPage(learnerBaseURL: string, trackingBackend: string): void;
    /**
     ...
     * generate areaFile
     */
    function storeMarkersAreaFileFromResolution(trackingBackend: any, resolutionW: any, resolutionH: any): void;
    function buildMarkersAreaFileFromResolution(trackingBackend: any, resolutionW: any, resolutionH: any): {
        meta: {
            createdBy: string;
            createdAt: string;
        };
